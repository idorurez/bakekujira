...
------------ | -------------
 ...
 LEDs | SK6812MINI-E | 104 (or get as many as you can) | |
 TRRS Connectors | MJ-4PP-9 | 2 | |
 Kailh hot swap sockets | n/a | As many as you can get | |
...
# Hints
* Order more than you need, these things are cheap
...
* Use a narrow tip as long as the tip will hold onto solder, otherwise you're chasing solder that's on the neck/stem of the tip, and not the very tip of the tip.

* LEDs
** When soldering the underglow LEDs, bend the terminals/legs down. You can't break these that easily.
** Solder the LEDs in the order that wired up, and 
